...
- [x] skills when touch on no trigger
- [x] remove css style when hover skill with mouse
- [x] skills button show cool down effect
- [x] Give first character of skill name as what shown on the skill button, give small number key to inform the user how to cast the skill as small circle on skill circle on the right, really small, ex: 1
- [x] Remove moving by a,w,s,d, replace with arrow keys
- [x] Same as basic attack button, i can press "a" to trigger basic attack
- [x] Basic attack can auto choose any near by enemy to fight
